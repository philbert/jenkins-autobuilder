...
sudo mv swarm-client-1.15-jar-with-dependencies.jar /usr/local/bin
sudo chown root:root /usr/local/bin/swarm-client-1.15-jar-with-dependencies.jar
sudo chmod +x /usr/local/bin/swarm-client-1.15-jar-with-dependencies.jar
